...
<<tree_prop, fig.height=4, fig.width=4, fig.align="center">>=
...
<<peer_prop, , fig.height=4, fig.width=4, fig.align="center">>=
...
<<tree_cent>>=
bb = betweenness.estimate(tree_g, v=V(tree_g), directed=FALSE, cutoff=16)
@

<<peer_cent>>=
bb = betweenness.estimate(peer_g, v=V(peer_g), directed=FALSE, cutoff=16)
@
